...
public class EntityHelper {
	/**
	 * Shrinks the itemstack in an entity and ensures that the new size is sent to
	 * clients
	 */
	 ...
	 * Since stacks do not implement equals, and we're not changing the actual stack
	 * object,
